...
async function editProduct(id){
    ...
    try{
        ...
        document.getElementById('kondisi').value = product.kondisi;
        document.getElementById('status').value = product.status;
        document.getElementById('deskripsi').value = product.deskripsi;
        document.getElementById('spesifikasi').value = product.spesifikasi || '';
        document.getElementById('include_item').value = product.include_item || '';
            ...
            product.images.forEach(img => {
                ...
                currentImages.innerHTML += `
                    ...
                    >
                        ...
                        <img
                            src="../uploads/products/${img.gambar}"
                        >
...
async function detailProduct(id){
    ...
    try{
        ...
        if (
            ...
            // gambar utama
            detailImage.src =
            `../uploads/products/${product.images[0].gambar}`;
